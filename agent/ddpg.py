...
class DDPGAgent(BaseAgent):
    def __init__(self, name, reward_free, obs_type, obs_shape, action_shape,
                 ...
                 num_expl_steps, stddev_schedule, nstep, batch_size, stddev_clip, 
                 init_critic, use_tb, use_wandb, update_every_steps=None, meta_dim=0):
        self.name = name
    ...
    def process_observation(self, obs):
        ...
        proc_obs = self.get_reduced_observation(aug_obs)
