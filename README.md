...
This codebase contains implementation and analysis of IRM from Skill-Based Reinforcement Learning with Intrinsic Reward Matching (Adeniji, Xie et al 2022). IRM leverages the skill discriminator from unsupervised RL pretraining to perform sample-free skill selection for unseen downstream tasks. 
