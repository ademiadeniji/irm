...
def make(task,
    ...
    task_kwargs['random_reset'] = random_reset
...
@SUITE.add()
def stand(time_limit=_DEFAULT_TIME_LIMIT, random=None, environment_kwargs=None, random_reset=False):
  """Returns the Walk task."""
  xml_string = make_model(floor_size=_DEFAULT_TIME_LIMIT * _WALK_SPEED)
  physics = Physics.from_xml_string(xml_string, common.ASSETS)
  task = Stand(random=random, random_reset=random_reset)
...
@SUITE.add()
def jump(time_limit=_DEFAULT_TIME_LIMIT, random=None, environment_kwargs=None, random_reset=None):
  """Returns the Walk task."""
  xml_string = make_model(floor_size=_DEFAULT_TIME_LIMIT * _WALK_SPEED)
  physics = Physics.from_xml_string(xml_string, common.ASSETS)
...
@SUITE.add()
def roll(time_limit=_DEFAULT_TIME_LIMIT, random=None, environment_kwargs=None, random_reset=None):
  """Returns the Walk task."""
  xml_string = make_model(floor_size=_DEFAULT_TIME_LIMIT * _WALK_SPEED)
  physics = Physics.from_xml_string(xml_string, common.ASSETS)
...
@SUITE.add()
def roll_fast(time_limit=_DEFAULT_TIME_LIMIT, random=None, environment_kwargs=None, random_reset=None):
  """Returns the Walk task."""
  xml_string = make_model(floor_size=_DEFAULT_TIME_LIMIT * _WALK_SPEED)
  physics = Physics.from_xml_string(xml_string, common.ASSETS)
...
def escape(time_limit=_DEFAULT_TIME_LIMIT, random=None,
           environment_kwargs=None, random_reset=None):
...
@SUITE.add()
def fetch(time_limit=_DEFAULT_TIME_LIMIT, random=None, environment_kwargs=None, random_reset=None):
...
class Stand(base.Task):
  ...
  def __init__(self, random=None, random_reset=False):
    """Initializes an instance of `Move`.
    Args:
      desired_speed: A float. If this value is zero, reward is given simply
        for standing upright. Otherwise this specifies the horizontal velocity
